...
def test_discover_hidden_skills_finds_underscore_prefixed(tmp_path: Path) -> None:
...
def test_discover_hidden_skills_returns_empty_for_no_hidden(tmp_path: Path) -> None:
